...
private suspend fun ImageCapture.takeJpegWithExif(executor: Executor, cacheDir: java.io.File): Pair<ByteArray, Int> =
  suspendCancellableCoroutine { cont ->
    val file = File.createTempFile("openclaw-snap-", ".jpg", cacheDir)
