...
class AndroidTTSProvider(private val context: Context) : TTSProvider {
    ...
    private fun findBestSplitPoint(text: String, offset: Int, limit: Int): Int {
        ...
        fun lastIndexOfBounded(delimiter: String): Int {
